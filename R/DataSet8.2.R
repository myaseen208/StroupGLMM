#' @title Data for Example 8.2 from Generalized Linear Mixed Models: Modern Concepts, Methods and Applications by Walter W. Stroup
#' @name   DataSet8.2
#' @docType data
#' @keywords datasets
#' @usage data(DataSet8.2)
#' @description DataSet8.2 is used for Incomplete strip-plot ( 3 cross 3 factorial).
